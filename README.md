...
```
# Login Usuario
Se debera enviar una peticio de tipo **POST** a la siguiente ruta:  **/api/users/login**
...
# Crear Factura
Se debe de enviar una petición de tipo **POST** a la siguiente ruta: **/api/invoice**
